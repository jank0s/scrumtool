...
History.create(sprint_id: 1, estimation: 1, project_id:1, story_id: 2, belongs_sprint: false)
History.create(sprint_id: 1, estimation: 3, project_id:1, story_id: 3, belongs_sprint: true)
