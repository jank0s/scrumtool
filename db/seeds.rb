...
Story.create(project_id: 1, name: "Story4", description: "Story four", priority_id: 1, finished: true, test: "", timeestimates: 1, finished_in_sprint: 1)

Task.create(name: "Task1.2", story_id: "1", completed: false, time_estimation: 6, assigned_date: "2014-05-28 00:00:00")
...
Worktime.create(done: 0, remaining: 4, day: "2014-05-20", task_id: 5, task_estimation: 4, sprint_id: 1, story_id: 2)
Worktime.create(done: 2, remaining: 2, day: "2014-05-21", task_id: 5, task_estimation: 4, sprint_id: 1, story_id: 2)
Worktime.create(done: 0, remaining: 4, day: "2014-05-22", task_id: 5, task_estimation: 4, sprint_id: 1, story_id: 2)
Worktime.create(done: 2, remaining: 1, day: "2014-05-23", task_id: 5, task_estimation: 4, sprint_id: 1, story_id: 2)
Worktime.create(done: 1, remaining: 0, day: "2014-05-24", task_id: 5, task_estimation: 4, sprint_id: 1, story_id: 2)

Worktime.create(done: 0, remaining: 6, day: "2014-05-20", task_id: 6, task_estimation: 6, sprint_id: 1, story_id: 2)
Worktime.create(done: 0, remaining: 6, day: "2014-05-21", task_id: 6, task_estimation: 6, sprint_id: 1, story_id: 2)
Worktime.create(done: 0, remaining: 6, day: "2014-05-22", task_id: 6, task_estimation: 6, sprint_id: 1, story_id: 2)
Worktime.create(done: 0, remaining: 6, day: "2014-05-23", task_id: 6, task_estimation: 6, sprint_id: 1, story_id: 2)
Worktime.create(done: 0, remaining: 6, day: "2014-05-24", task_id: 6, task_estimation: 6, sprint_id: 1, story_id: 2)
